...
def main():
    ...
    training_args = GRPOConfig(
        ...
        use_vllm=True,                   # Enable vLLM interface (Ollama is compatible)
        vllm_device="remote",            # Use the Mac
        vllm_remote_address="http://100.118.255.63:11434/v1" # Mac Tailscale IP
    )
